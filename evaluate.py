...
parser.add_argument('--image_data_dir', type=str, default='/workspace/ruochen/source/full/pic',
                    help='The directory containing the image data.')

parser.add_argument('--region_data_dir', type=str, default='/workspace/ruochen/source/full/region',
                    help='The directory containing the ground truth label data.')

parser.add_argument('--label_data_dir', type=str, default='/workspace/ruochen/source/full/label',
                    help='The directory containing the ground truth label data.')

parser.add_argument('--evaluation_data_list', type=str, default='/workspace/ruochen/index/testing.txt',
                    help='Path to the file listing the evaluation images.')

parser.add_argument('--model_dir', type=str, default='/workspace/ruochen/results/save_ConvLSTM_4_1/',
